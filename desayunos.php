<?php 
 ...
 ?>
 <br>
 <h2 class="text-center" style="font-size: 2.2vw; color: #f4d661">Desayunos</h2><br>
 <div class="row">
 	<div class="col-2"></div>
	 <div class="col-8">
		<div class="row container-fluid">
			<?php 
				$sql= "SELECT * FROM menu WHERE categoria='desayuno' ORDER BY nombre";
			 ...
			 ?>
				...
				<div class="col-4">
						...
						<span id="detalles"><?php echo $consulta['nombre']; ?></span><br>
						<span style="font-size: 1.5vw; color: white; font-family: Times New Roman"><?php echo $consulta['ingredientes']; ?></span>
