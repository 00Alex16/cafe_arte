<?php 
 ...
 ?>
 <br>
 <h2 class="text-center" style="font-size: 2.2vw; color: #f4d661">Infusiones</h2><br>
 <div class="row">
 	<div class="col-2"></div>
	 <div class="col-8">
		<div class="row container-fluid">
			<?php 
				$sql= "SELECT * FROM menu WHERE categoria='infusion' ORDER BY nombre";
								      ...
								      <div class="modal-body">
								        <div class="row">
								        	...
								        	<div class="col-4">
								        		...
								        		<br><br>
								        		<h5 style="font-size: 1.6vw">Propiedades</h5>
								        		<span id="modal"><?php echo $consulta['propiedades']; ?></span>
								        	</div>
								        </div>
								      </div>
